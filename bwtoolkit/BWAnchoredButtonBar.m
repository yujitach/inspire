...
+ (void)initialize;
{
	...
	resizeHandleColor	 = [NSColor colorWithCalibratedWhite:(0.0f / 255.0f) alpha:0.598f];
	resizeInsetColor	 = [NSColor colorWithCalibratedWhite:(255.0f / 255.0f) alpha:0.55f];
}
